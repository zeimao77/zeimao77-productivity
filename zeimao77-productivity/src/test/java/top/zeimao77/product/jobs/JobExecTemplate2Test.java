...
class JobExecTemplate2Test extends BaseMain {
    ...
    @Test
    void addJob() {
        JobExecTemplate2 jobExecTemplate2 = new JobExecTemplate2<JobExecTemplateTest.Job>(1024);
        ...
        jobExecTemplate2.start(2);
        for (int i = 0; i < 10; i++)
            jobExecTemplate2.addJob(new JobExecTemplateTest.Job());
        delay_ms(9000);
        for (int i = 0; i < 10; i++)
            jobExecTemplate2.addJob(new JobExecTemplateTest.Job());
